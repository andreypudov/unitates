...
void main() {
  group("should convert correctly", () {
    Map<Length, List<double>> implementation = {
      ...
      Length(1, LengthUnit.yard):         [ 0.0009140767824497258,   0.9144,    91.44,    914.4,     914400,     914400000,   0.0005681818181818182,                     1,                        3,                   36,   0.0004937369468294682],
    ...
    Map<Length, List<double>> requirements = {
      ...
      Length(1, LengthUnit.yard):         [             0.0009141,   0.9144,    91.44,    914.4,     914400,      9.144e+8,             0.000568182,                     1,                        3,                   36,             0.000493737],
    ...
    // TODO: 1 yard to km should be 0.0009144, not 0.0009141
